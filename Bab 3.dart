...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    },
    {
      ...
      "profession": "Beautician",
      "rating": 4.9,
      "image": "assets/images/gambar6.jpg"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/gambar7.jpg',
          name: 'Ayo beli Laptop',
          role: 'Electronik',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/gambar8.jpg',
          name: 'Tentang E-Commerce',
          role: 'Desain',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'assets/images/gambar9.jpg',
          name: 'Code Girl ',
          role: 'Pemrograman',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
  ...
  Widget build(BuildContext context) {
    return Column(
        children: [
          BestBookingCard(
            imageUrl: 'assets/images/gambar7.jpg',
            profileUrl: 'assets/images/gambar8.jpg',
            name: 'About E-Commerce',
            role: 'Tentang E-Commerce',
            description: 'Segala hal tentang E-Commerce .',
            rating: 4.9,
          ),
          SizedBox(height: 16.0),
          BestBookingCard(
            imageUrl: 'assets/images/gambar6.jpg',
            profileUrl: 'assets/images/gambar2.jpg',
            name: 'PC spek bagus',
            role: 'Pc Keren',
            description: 'Belajar auto semangat.',
            rating: 4.9,
          ),
        ],
      );
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/gambar2.jpg', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
